                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="https://github.com/divyanshojha99" target="_blank"><button className={styles.cta} aria-label="View Repository">
                                <GitHubLogo className={styles.ctaSVG} />
                                GitHub
                              </button></a>
                              <a href="https://www.linkedin.com/in/astrohere/" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open LinkedIn">
                    ...
                    <div className={styles.right}>
                        <div className={styles.buttonsRight}>
                            ...
                            <a href='https://github.com/divyanshojha99' target="_blank"><button className={styles.cta} aria-label="Open commit log">
                              <Git className={styles.ctaSVG} />
                              Commit Log
                            </button></a>
                            <a href="https://github.com/divyanshojha99/react_ecomsite/blob/main/README.md#performance" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open performance test results">
                              <Performance className={`${styles.ctaSVG}`} />
                              Performance
                            </button></a>
                            <a href="https://github.com/divyanshojha99/react_ecomsite/blob/main/README.md#technologies-used" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View technologies used"> 
                              <img className={styles.technologies} src={require("../../Resources/image/whatruns.png")} alt="WhatRuns logo"/>
                              Technologies
                            </button></a>
                            <a href="https://github.com/divyanshojha99/react_ecomsite/blob/main/README.md#sources" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View Sources">
